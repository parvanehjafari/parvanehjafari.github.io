...
title: "Dr. parvaneh Pirahansiah — Complete Portfolio"
...
Dr. parvaneh Pirahansiah — Computer Vision expert with 10+ years R&D. 3 AI patents, 141+ citations (h-index 7), Springer book chapter author. Specializes in real-time image processing, edge AI across Jetson, Raspberry Pi, Hailo, Axelera, ARM. Full-stack CV/DL: model training → fine-tuning → deployment → API integration.
...
- **@image_processing_parvaneh_bot** — Send images, apply OpenCV functions (Canny, etc.), get instant results. Payment via TON/stars.
