...
<div class="google-search-box">
  <div class="i18n" data-lang="de">
    ...
    <form onsubmit="googleSearch(event)">
      <input type="text" id="search-input" placeholder="parvanehjafari.github.io durchsuchen..." autofocus>
      <br>
  ...
  <div class="i18n" data-lang="en">
    ...
    <form onsubmit="googleSearch(event)">
      <input type="text" id="search-input" placeholder="Search parvanehjafari.github.io..." autofocus>
      <br>
...
function googleSearch(e) {
  ...
  if (q) {
    window.location.href = "https://www.google.com/search?q=site:parvanehjafari.github.io+" + encodeURIComponent(q);
  }
}
</script>
